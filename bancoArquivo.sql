...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09/06/2026 às 03:34
...
INSERT INTO `clientes` (`id`, `nome`, `altura`, `nascimento`, `cidade`) VALUES
(1, 'Adalto Ass', NULL, NULL, 4);
...
(2, '0000-00-00 00:00:00', 'Casa do Adalto', 1);
...
--
ALTER TABLE `clientes`
  ADD CONSTRAINT `clientes_ibfk_1` FOREIGN KEY (`cidade`) REFERENCES `cidades` (`id`);
